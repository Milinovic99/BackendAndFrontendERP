...
@Component({
  selector: 'app-wine-and-champaign-dialog',
  templateUrl: './wine-and-champaign-dialog.component.html',
  styleUrls: ['./wine-and-champaign-dialog.component.css']
})
export class WineAndChampaignDialogComponent implements OnInit {
  public flag:number;
  constructor(public snackBar: MatSnackBar,
    public dialogRef: MatDialogRef<WineAndChampaignDialogComponent>,
