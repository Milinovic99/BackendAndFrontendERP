...
@Component({
  selector: 'app-energetic-drink-dialog',
  templateUrl: './energetic-drink-dialog.component.html',
  styleUrls: ['./energetic-drink-dialog.component.css']
})
export class EnergeticDrinkDialogComponent implements OnInit {

  public flag:number;
  constructor(public snackBar: MatSnackBar,
    public dialogRef: MatDialogRef<EnergeticDrinkDialogComponent>,
