...
@Component({
  selector: 'app-all-products-dialog',
  templateUrl: './all-products-dialog.component.html',
  styleUrls: ['./all-products-dialog.component.css']
})
export class AllProductsDialogComponent implements OnInit {

  public flag:number;
  constructor(public snackBar: MatSnackBar,
    public dialogRef: MatDialogRef<AllProductsDialogComponent>,
