...
@Component({
  selector: 'app-tea-dialog',
  templateUrl: './tea-dialog.component.html',
  styleUrls: ['./tea-dialog.component.css']
})
export class TeaDialogComponent implements OnInit {
  public flag:number;
  constructor(public snackBar: MatSnackBar,
    public dialogRef: MatDialogRef<TeaDialogComponent>,
