...
@Component({
  selector: 'app-juice-dialog',
  templateUrl: './juice-dialog.component.html',
  styleUrls: ['./juice-dialog.component.css']
})
export class JuiceDialogComponent implements OnInit {

  public flag:number;
  constructor(public snackBar: MatSnackBar,
    public dialogRef: MatDialogRef<JuiceDialogComponent>,
